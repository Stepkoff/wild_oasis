        ...
        <Modal>
          <Menus.Menu>
            ...
            <Menus.List id={cabin.id}>
              <Menus.Button disabled={isPending || isCreating} onClick={handleDuplicateCabin} icon={<HiSquare2Stack/>}>Duplicate</Menus.Button>
              <Modal.Open openWindowName={'cabin-form'}>
                <Menus.Button disabled={isPending || isCreating} icon={<HiPencil/>}>Edit</Menus.Button>
              </Modal.Open>
              <Modal.Open openWindowName={'confirm-delete'}>
                <Menus.Button disabled={isPending || isCreating} icon={<HiTrash/>}>Delete</Menus.Button>
              </Modal.Open>
            </Menus.List>
          </Menus.Menu>
          ...
          <Modal.Window openWindowName={'confirm-delete'}>
